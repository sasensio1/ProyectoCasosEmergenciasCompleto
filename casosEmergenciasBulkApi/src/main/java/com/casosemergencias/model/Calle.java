...
import com.casosemergencias.controller.views.StreetView;
import com.casosemergencias.dao.vo.StreetVO;

public class Calle extends ObjectLogic {
	...
	public Object instantiateTargetVO() {
		StreetVO calle = new StreetVO();
		return calle;
	}

	@Override
	public Object instantiateTargetView() {
		StreetView calleView = new StreetView();
		return calleView;
	}
}